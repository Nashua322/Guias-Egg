...
public class POOEjercicio09 {
    ...
    public static void main(String[] args) {
        ...
        MatematicaService.asignarNum(calculo);
        
        MatematicaService.devolverMayor(calculo);
        
        MatematicaService.calcularPotencia(calculo);
        
        MatematicaService.calculaRaiz(calculo);
